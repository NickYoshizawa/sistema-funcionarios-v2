...
class SearchField(ctk.CTkFrame):
    def __init__(self, master, callback_search ,width = 200, height = 200, corner_radius = 8, border_width = 2, bg_color = "transparent", fg_color = None, border_color = None, background_corner_colors = None, overwrite_preferred_drawing_method = None, **kwargs):
